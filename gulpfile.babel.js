...
gulp.task("copy", () =>
  gulp
    .src(["app/*", "!app/images", "!app/scss", "!app/*.html"], {
      dot: true
    })
    .pipe(gulp.dest("dist"))
...
gulp.task("styles:watch", () => runSequence("styles:scss", "styles:concat"));

// Minify resulting css file
gulp.task("styles:minify", () =>
  gulp
    .src([".tmp/css/styles.css", "dist/css/styles.css"])
...
gulp.task("scripts:uglify", () =>
  gulp
    .src(["./dist/js/main.js", "./tmp/js/main.js"])
